<%@ Page Title="Payit - Charity" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="alRahmaCharity.aspx.vb" Inherits="alRahmaCharity" %>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <h4> <asp:Label ID="lblheading"  Text="<%$Resources:Resource, CharityHeading %>" runat="server"
                Font-Bold="true" Font-Size="Larger" Font-Underline="False" ForeColor="White" />
                    </h4>
                <ol class="pull-right">
                    <asp:LinkButton ID="LinkButton1" runat="server" Text="<%$Resources:Resource, Export %>"></asp:LinkButton>
                </ol>
            </div>
                ...
                <div class="col-md-6" style="float: inherit">
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                 <p><asp:Label ID="Label5" runat="server" Text="<%$Resources:Resource, AddCharity %>" ></asp:Label></p>
                                 <label>
                                    <div>
                                        <asp:Label ID="Label4" runat="server" Text="<%$Resources:Resource, Service %>" ></asp:Label>
                                    </div>
                                     <asp:DropDownList runat="server" ID="ddlServiceName" AutoPostBack="false"></asp:DropDownList>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label1" runat="server" Text="<%$Resources:Resource, Project %>"></asp:Label>
                                    </div>
                                    <asp:TextBox ID="zakName" runat="server"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label3" runat="server" Text="<%$Resources:Resource, Desc %>"></asp:Label>
                                    </div>
                                    <asp:TextBox ID="zakDesc" runat="server"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label2" runat="server" Text="<%$Resources:Resource, Priority %>"></asp:Label>
                                    </div>
                                ...
                                <div class="label-group input-below">
                                    ...
                                    <label>
                                        <asp:CheckBox runat="server" ID="chkStatus" Text="<%$Resources:Resource, Status %>" AutoPostBack="false" />
                                        
                                    </label>
                                </div>
                                <div class="submit-wrapper pull-right">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-default btn-sm" Text="<%$Resources:Resource, CharityButton %>"/>
                                </div>
                            </fieldset>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-success">
                        <h4 class="box-title"><asp:Label ID="Label6" runat="server" Text="<%$Resources:Resource, CharityDetails %>"></asp:Label></h4>
                        <div class="box-body">
                             <asp:GridView ID="GridView1" runat="server" EmptyDataText="No Data" CssClass="table table-bordered table-responsive" 
                                 AutoGenerateColumns="false" BackColor="#2b2028" HeaderStyle-ForeColor="White" HorizontalAlign="Center" 
                                 OnRowDataBound="GridView1_RowDataBound" PageSize="50" ForeColor="White">
                            ...
                            <emptydatatemplate>
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="ProjectName" HeaderText="<%$Resources:Resource, Project %>" SortExpression="ProjectName" />
                                    <asp:BoundField DataField="Description" HeaderText="<%$Resources:Resource, Desc %>" SortExpression="Description" />
                                    ...
                                    <asp:BoundField DataField="Service" HeaderText="<%$Resources:Resource, Service %>" SortExpression="Service" />
            ...
            <asp:Panel ID="pnlAddEdit" runat="server" CssClass="panel panel-danger modalPopup">
                            <div class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <label>
                                        <div>
                                            <asp:Label ID="Label17" runat="server" Text="ProjectName"></asp:Label>
                                        </div>
                                        <asp:TextBox runat="server" ID="txtProjectNameEdit"></asp:TextBox>
                                    </label>
                                   <label>
                                    <div>
                                        <asp:Label ID="Label8" runat="server" Text="ProjectDesc"></asp:Label>
                                    </div>
                                        <asp:TextBox runat="server"  ID="txtProjectDescEdit"></asp:TextBox>
                                    </label>
                                     <label>
                                    <div>
