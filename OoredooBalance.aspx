<%@ Page Language="VB" MasterPageFile="~/MasterPage3.master" AutoEventWireup="false" CodeFile="OoredooBalance.aspx.vb" Inherits="OoredooBalance" title="Pay-it Support-Balance" %>
     ...
     <Triggers>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView2" runat="server" BorderColor="DimGray" 
                ...
                Font-Size="Smaller" ForeColor="White" HorizontalAlign="Center" PageSize="50">
