<%@ Page Title="OgMoneyKW:Fraud Rules" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="FraudRules.aspx.vb" Inherits="FraudRules" %>
                        ...
                        <div class="col-md-6">
                            <div class="">
                                ...
                                <div class="form-horizontal">
                                    <fieldset>
                                        <p>Add Rule Details</p>
                                        <label>
                                            <div>
                                                <asp:Label ID="Label1" runat="server" Text="Rule Type"></asp:Label>
                                            </div>
                                            <asp:DropDownList ID="ddlRuleType" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlRule_SelectedIndexChanged">
                                            </asp:DropDownList>
                                        </label>
                                        <label>
                                            <div>
                                        ...
                                        <label>
                                            <div>
                                                <asp:Label ID="Label6" runat="server" Text="Limit Type"></asp:Label>
                                            </div>
                                        ...
                                        <label>
                                            <div>
                                                <asp:Label ID="Label10" runat="server" Text="Limit Value"></asp:Label>
                                            </div>
                                            <asp:TextBox runat="server" ID="txtLimitValue"></asp:TextBox>
                                        </label>
                                        <label>
                                            <div>
                                                <asp:Label ID="LabelServ" runat="server" Text="Duration"></asp:Label>
                                            </div>
                                            <asp:TextBox runat="server" ID="txtDuration" placeholder="In Days"></asp:TextBox>
                                        </label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">Business Rule Details</h4>
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Info2" HeaderText="Config" SortExpression="Info2" />
