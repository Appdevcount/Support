<%@ Page Title="Payit:AppPaymentSettings" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="AppPaymentSettings.aspx.vb" Inherits="AppPaymentSettings" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="row" id="contact">
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                <p>Add AppUserPayment Configuration</p>
                                <label>
                                    <div>
                                ...
                                <label>
                                    <div>
                                        <asp:Label ID="Label1" runat="server" Text="Service Payment"></asp:Label>
                                    </div>
                                    <asp:DropDownList ID="ddlServicePayment" runat="server" AutoPostBack="false">
                                    </asp:DropDownList>
                                </label>
                                <label>
                                        <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">AppUserPaymentConfiguration Details</h4>
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" CssClass="table table-bordered table-responsive" runat="server" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="ServiceAndPaymentID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="ID" />
                                            ...
                                            <asp:BoundField DataField="AppUser" HeaderText="AppUser" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" SortExpression="AppUser" />
                                            <asp:BoundField DataField="Service" HeaderText="ServiceCode" SortExpression="ServiceCode" />
                       ...
                       <asp:Panel ID="pnlAddEdit" runat="server" CssClass="panel panel-danger modalPopup">
                            <div class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <label>
                                        <div>
                                            <asp:Label ID="Label17" runat="server" Text="Service Payment"></asp:Label>
                                        </div>
                                        <asp:DropDownList runat="server" ID="ddlServicePaymentEdit" disabled="disabled"></asp:DropDownList>
                                    </label>
                                   <label>
                                        <div>
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlServicePayment" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </div>
