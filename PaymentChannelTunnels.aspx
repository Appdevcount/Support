<%@ Page Title="OgMoneyKW:Payment Channel Tunnels" Language="VB" AutoEventWireup="false" MasterPageFile="~/MasterPage2.master"  CodeFile="PaymentChannelTunnels.aspx.vb" Inherits="PaymentChannelTunnels" %>
                            ...
                            <div class="">
                                ...
                                <div class="form-horizontal">
                                    <fieldset>
                                        ...
                                        <label>
                                            <div>
                                                <asp:Label ID="Label2" runat="server" Text="Payment Channel"></asp:Label>
                                            </div>
                                            <asp:DropDownList ID="ddlPaymentChannel" runat="server" AutoPostBack="false">
                                            </asp:DropDownList>
                                        </label>

                                          <label>
                                            <div>
                                                <asp:Label ID="Label1" runat="server" Text="Tunnel Alias"></asp:Label>
                                            </div>
                                            <asp:TextBox runat="server" ID="txtAlias"></asp:TextBox>
                                        </label>
                                         <label>
                                            <div>
                                                <asp:Label ID="Label10" runat="server" Text="Tunnel Code"></asp:Label>
                                            </div>
                                            <asp:TextBox runat="server" ID="txtTunnel"></asp:TextBox>
                                        </label>
                                        ...
                                        <div class="submit-wrapper pull-right">
                                            <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-default btn-sm" Text="Add Tunnel" />
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">Payment Channel Tunnel Details</h4>
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" runat="server" OnRowDataBound="OnRowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="TunnelAlias" HeaderText="Tunnel" SortExpression="TunnelAlias" />
                                            <asp:BoundField DataField="TunnelCode" HeaderText="Code" SortExpression="TunnelCode" />
                                            <asp:BoundField DataField="UpdatedBy" HeaderText="AddedBy" SortExpression="UpdatedBy" />
