<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="UserFavorites.aspx.vb" Inherits="UserFavorites" %>
                    ...
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                ...
                                <label>
                                    <div>
                                        <asp:Label ID="Label6" runat="server" Text="PaymentChannel"></asp:Label>
                                    </div>
                                     <asp:TextBox runat="server" ID="txtPayChannel"></asp:TextBox>
                                </label>
                                 <label>
                                    <div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">User Favorites Details</h4>
                                <div class="box-body">
                                    ...
                                    <asp:GridView ID="GridView1" CssClass="table table-bordered" runat="server" BorderColor="DimGray" BorderStyle="Outset"
                                        ...
                                        <asp:BoundField DataField="ID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="ID" />
                                           <asp:TemplateField ItemStyle-Width="30px" HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" ForeColor="SteelBlue" runat="server" Text='<%#Eval("UserIdentifier")%>' OnClick="UserInfo"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:BoundField DataField="ServiceCode" HeaderText="ServiceCode" SortExpression="ServiceCode" />
                                            <asp:BoundField DataField="PaymentChannelCode" HeaderText="PaymentChannel" SortExpression="PaymentChannelCode" />
