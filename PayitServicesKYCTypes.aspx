<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PayitServicesKYCTypes.aspx.vb" Inherits="PayitServicesKYCTypes" %>
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                <p>Add PayitServices KYCTypes</p>
                                <label>
                                    <div>
                                        <asp:Label ID="Label14" runat="server" Text="KYCType"></asp:Label>
                                    </div>
                                   <asp:DropDownList runat="server" ID="ddlKYCType"></asp:DropDownList>
                                </label>
                                 <label>
                                    <div>
                                ...
                                <div class="submit-wrapper pull-right">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-default btn-sm" Text="Add Rating" />
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">KYC Rating Details</h4>
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" CssClass="table" runat="server" BorderColor="DimGray" BorderStyle="Outset"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="KYCTypeID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="KYCTypeID" SortExpression="KYCTypeID" />
                                            <asp:BoundField DataField="PayitServiceID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="PayitServiceID" />
                                            <asp:BoundField DataField="KYCType" HeaderText="KYCType" SortExpression="KYCType" />
                       ...
                       <asp:Panel ID="pnlAddEdit" runat="server" CssClass="panel panel-danger modalPopup">
                            <div class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <label>
                                        <div>
                                            <asp:Label ID="Label17" runat="server" Text="KYCType"></asp:Label>
                                        </div>
                                        <asp:DropDownList runat="server" ID="ddlKYCTypeEdit"></asp:DropDownList>
                                    </label>
                                    <label>
                                        <div>
