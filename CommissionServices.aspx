<%@ Page Title="Payment Commissions" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="CommissionServices.aspx.vb" Inherits="CommissionServices" %>
        ...
        <div class="content-wrapper">
                    ...
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                ...
                                <label>
                                    <div>
                                        <asp:Label ID="Label2" runat="server" Text="Payment Name"></asp:Label>
                                    </div>
                                    <asp:DropDownList ID="ddlPaymentCode" runat="server" AutoPostBack="false">
                                    </asp:DropDownList>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label4" runat="server" Text="Commission Type"></asp:Label>
                                    </div>
                                    <asp:DropDownList ID="ddlCommType" runat="server" AutoPostBack="false">
                                    </asp:DropDownList>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="LabelServ" runat="server" Text="Commission Value"></asp:Label>
                                    </div>
                                    <asp:TextBox runat="server" ID="txtCommission"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label5" runat="server" Text="Threshold Type"></asp:Label>
                                    </div>
                                    <asp:DropDownList ID="ddlThreshold" runat="server" AutoPostBack="false">
                                    </asp:DropDownList>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label6" runat="server" Text="Threshold Value"></asp:Label>
                                    </div>
                                    <asp:TextBox runat="server" ID="txtThreshold"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label12" runat="server" Text="Comm. Msg"></asp:Label>
                                    </div>
                                    <asp:TextBox runat="server" ID="txtCommissionMessage"></asp:TextBox>
                                </label>
                                <div class="label-group input-below">
                                    <label style="visibility: hidden">Push Notificationss</label>
                                    <label>
                                        <asp:CheckBox runat="server" ID="chkMandatory" AutoPostBack="false" />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" CssClass="table" runat="server" BorderColor="DimGray" BorderStyle="Outset"
                                        ...
                                        <Columns>
                                            <asp:BoundField DataField="CommissionID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="ID" />
                                            <asp:BoundField DataField="ServiceCode" HeaderText="ServiceCode" SortExpression="ServiceCode" />
                                            <asp:BoundField DataField="PaymentCode" HeaderText="PaymentCode" SortExpression="PaymentCode" />
                                            <asp:BoundField DataField="CommissionType" HeaderText="CommissionType" SortExpression="CommissionType" />
                                            <asp:BoundField DataField="CommissionValue" HeaderText="CommissionValue" SortExpression="CommissionValue" />
                                            <asp:BoundField DataField="Threshold" HeaderText="Threshold" SortExpression="Threshold" />
                                            <asp:BoundField DataField="ThresholdType" HeaderText="ThresholdType" SortExpression="ThresholdType" />
                                            ...
                                            <asp:TemplateField HeaderText="IsMandatory" SortExpression="IsMandatory">
                                                <ItemTemplate><%#IIf(Boolean.Parse(Eval("IsMandatory").ToString()), "Yes", "No")%></ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:BoundField DataField="IsMandatory" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="IsMandatory" SortExpression="IsMandatory" />
                                            <asp:BoundField DataField="CommissionMsg" HeaderText="CommissionMsg"  SortExpression="CommissionMsg" />
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlServType" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </div>
