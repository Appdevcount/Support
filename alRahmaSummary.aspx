<%@ Page Title="Charity Summary" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="alRahmaSummary.aspx.vb" Inherits="alRahmaSummary" %>
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                ...
                                <label>
                                    ...
                                    <asp:DropDownList ID="ddlServiceName" OnSelectedIndexChanged="ddlServiceName_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                                </label>
                                <label>
                                    <div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="box box-success">
                        <h4 class="box-title"><asp:Label runat="server" ID="serviceLabel" Text="Charity Project Details" ></asp:Label></h4>
                        <div class="box-body">
