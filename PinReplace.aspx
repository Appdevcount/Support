<%@ Page Title="Payit:Pin Replace" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PinReplace.aspx.vb" Inherits="PinReplace" %>
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Amount" ReadOnly="true" HeaderText="Denom" SortExpression="Denomination" />
                                            ...
                                            <fieldset>
                                                <label class="hiddencol">
                                                 ...
                                                 <label>
                                                    ...
                                                    <asp:DropDownList runat="server" ID="ddlServiceNameEdit" disabled="disabled"></asp:DropDownList>
                                                </label>
                                                 <label>
                                                    <div>
                                                        <asp:Label ID="Label6" runat="server" Text="Denom"></asp:Label>
                                                    </div>
                                                    <asp:DropDownList runat="server" ID="ddlDenomEdit" disabled="disabled"></asp:DropDownList>
                                                </label>
                                                 <label>
                                                    <div>
                                                        <asp:Label ID="Label8" runat="server" Text="Amount"></asp:Label>
                                                    </div>
                                                    <asp:DropDownList runat="server" ID="ddlAmountEdit" disabled="disabled"></asp:DropDownList>
                                                </label>
                                                  ...
                                                  <label>
                                                    ...
                                                    <asp:TextBox ID="txtSerial" runat="server" disabled="disabled"></asp:TextBox>
                                                </label>
                                                 ...
                                                 <label>
                                                    ...
                                                    <asp:TextBox ID="txtPin" runat="server" disabled="disabled"></asp:TextBox>
                                                </label>

                                                <label>
                                                    <div>
                                                        <asp:Label ID="Label2" runat="server" Text="TrackId"></asp:Label>
                                                    </div>
                                               ...
                                               <%-- <label>
                                                ...
                                                <label>
                                                    <asp:Label ID="SerialVal" CssClass="hidden-col" Visible="false" runat="server"></asp:Label>
                                                </label>
                                                <label>
                                                    <asp:Label ID="PinVal" CssClass="alert alert-success" Visible="false"  runat="server"></asp:Label>
                                                </label>
                                                <div class="label-group input-below">
                                                    <label style="visibility: hidden">Push Notificationss</label>
                                                    <label>
                                                        <asp:CheckBox runat="server" ID="chkStatEdit" AutoPostBack="false" />
                                                        <span class="text-default" style="color: #fff;">NOT SOLD</span>
                                                    </label>
                                                </div>
                                                  ...
                                                  <div class="label-group input-below">
                                                    <label style="visibility: hidden">Push Notificationss</label>
                                                    <label>
                                                        <asp:CheckBox runat="server" ID="chkSms" AutoPostBack="false" />
                                                        <span class="text-default" style="color: #fff;">Send SMS</span>
                                                    </label>
                                                </div>
