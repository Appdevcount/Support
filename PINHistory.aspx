<%@ Page Title="PayitSupport: PIN History" Language="VB"  MasterPageFile="~/MasterPage2.master"  AutoEventWireup="false" CodeFile="PINHistory.aspx.vb" Inherits="PINHistory" %>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <ol class="pull-right">
                    ...
                    <br />
                    <a href="UploadPINHistory.aspx">Old Upload History</a>
            ...
            <div class="row" id="contact">
                            ...
                            <div class="box box-success">
                                ...
                                <div class="box-body">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" CssClass="table table-bordered table-responsive" HeaderStyle-ForeColor="White"
                                        BackColor="#2b2028" ForeColor="White" BorderStyle="None" CellPadding="0" HorizontalAlign="Center" OnPageIndexChanging="OnPaging" OnRowDataBound="GridView1_RowDataBound" PageSize="25">
                ...
                <Triggers>
                    ...
                    <asp:AsyncPostBackTrigger ControlID="ddlServiceName" />
                </Triggers>
            </asp:UpdatePanel>
        </div>
    </div>
