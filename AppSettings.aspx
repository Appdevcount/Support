<%@ Page Title="Payit: AppServiceSettings" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="AppSettings.aspx.vb" Inherits="AppSettings" %>
                ...
                <div class="col-md-6">
                    <div class="">
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                <p>Add APP Configuration</p>
                                <label>
                                    <div>
                                        <a class="button-secondary pure-button button-small" role="button" data-toggle="collapse" href="#collapseExample" aria-expanded="true" aria-controls="collapseExample"> Recent Config </a>
                                    </div>
                                     ...
                                     <div class="collapse in" id="collapseExample" aria-expanded="true"> 
                                         <div class="well well-sm"><p> Don't select Service if selecting from Recent Configuration. </p></div>
                                    </div>
                                </label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">AppUserConfiguration Details</h4>
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" CssClass="table table-bordered table-responsive" runat="server" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UsersID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="ID" />
                                            <asp:BoundField DataField="ServiceID" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="ID" SortExpression="ID" />
                            ...
                            <div class="form-horizontal">
                                ...
                                <fieldset>
                                    ...
                                    <label>
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlServiceEdit" disabled="disabled"></asp:DropDownList>
                                    </label>
                                    <label>
                                        <div>
