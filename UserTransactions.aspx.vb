...
Partial Class UserTransactions
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        If Not (Session("role") = "superadmin" Or Session("role") = "accounts" Or Session("role") = "cs" Or Session("role") = "operations" Or Session("role") = "qa") Then
            ...
            Response.Redirect("~/login.aspx?ReturnURL=UserTransactions.aspx")
        End If
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        If Page.IsValid Then
            ...
            Using cmd1 As New SqlCommand(sql1, cn)
                cmd1.Connection = cn
                cmd1.Parameters.AddWithValue("@trackID", txtTrackId.Text.Trim())
                ...
                cmd1.Parameters.AddWithValue("@tranType", txtTransType.Text)
                cmd1.Parameters.AddWithValue("@tranStatus", txtTransStatus.Text)
    ...
    Private Sub BindData()
        Dim strQuery As String = ("SELECT TOP 1000 [ID],[TrackID],[UserIdentifier],[Amount],[Currency],[ServiceCode] " & _
      " ,[PaymentChannelCode] PaymentChannel,[ProcessDate],[UserMobileNumber],[PaymentReference],[TransactionType],[TransactionStatus],[Quantity],[TotalAmount],[Status]" & _
      " FROM [payit].[dbo].[UserTransactions] order by ID desc")
    ...
    Protected Sub UserInfo(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Dim inp As New PayitWallet.GetProfileInfo
        inp.userid = txtUID.Text
        service.input = inp
