<%@ Page Title="KYC Types" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="KYCTypes.aspx.vb" Inherits="KYCTypes" %>
                        ...
                        <div class="form-horizontal">
                            <fieldset>
                                ...
                                <label>
                                    ...
                                    <asp:TextBox runat="server" ID="txtKYCName"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                ...
                                <div class="submit-wrapper pull-right">
                                    <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-default btn-sm" Text="Add Type" />
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="box box-success">
                                <h4 class="box-title">KYCType Details</h4>
                                <div class="box-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <fieldset>
                                ...
                                <label>
                                    ...
                                    <asp:TextBox runat="server" ID="txtNameEdit"></asp:TextBox>
                                </label>
                                <label>
                                    <div>
                                        <asp:Label ID="Label3" runat="server" Text="Description"></asp:Label>
                                    </div>
                                    <asp:TextBox runat="server" ID="txtDescEdit"></asp:TextBox>
                                </label>
                                <div class="label-group input-below">
                                    <label style="visibility: hidden">Push Notificationss</label>
                                    <label>
