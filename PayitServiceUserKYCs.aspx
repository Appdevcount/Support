<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="PayitServiceUserKYCs.aspx.vb" Inherits="PayitServiceUserKYCs" %>
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" CssClass="table" runat="server" BorderColor="DimGray" BorderStyle="Outset"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UserIdentifier" ItemStyle-CssClass="hiddencol" HeaderStyle-CssClass="hiddencol" HeaderText="UserIdentifier" SortExpression="UserIdentifier" />
                                            ...
                                            <asp:BoundField DataField="UserIdentifier" HeaderText="UserIdentifier" SortExpression="UserIdentifier" />
